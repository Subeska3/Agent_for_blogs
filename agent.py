...
""",
    output_key="blog_outline" # whateever the agent writes will be stored in shared state under this key. 
    #So that the next agent can access it.
)
